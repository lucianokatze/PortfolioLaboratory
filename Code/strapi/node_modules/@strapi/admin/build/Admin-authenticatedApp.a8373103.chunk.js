"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[801],{29761:function(Q,S,n){n.r(S),n.d(S,{default:function(){return Qt}});var e=n(32735),s=n(24989),L=n(20108),v=n(33795),O=n.n(v),P={i8:"4.10.2"},C=n(67927),E=n(53038),y=n(15062),G=n(74506),z=n(51968),K=n(88311),ae=n.n(K),Le=n(58107),T=n(8471),Oe=n(60216),r=n.n(Oe),Z=n(67879),m=n(87933),oe=n(71933),V=n(67563),xe=n(50563),M=n(72850),Y=n(41415),se=n(35331);const be=(0,T.ZP)(m.k)`
  position: fixed;
  z-index: 4;
  inset: 0;
