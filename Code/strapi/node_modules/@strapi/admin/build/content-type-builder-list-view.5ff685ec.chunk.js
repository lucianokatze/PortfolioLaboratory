"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[5905],{69073:function(H,R,n){n.r(R),n.d(R,{default:function(){return it}});var e=n(32735),a=n(24989),C=n(19406),p=n(66456),A=n(68625),X=n(29439),G=n(82055),T=n(87933),P=n(41415),z=n(17e3),s=n(72850),J=n(33795),f=n.n(J),m=n(23973),x=n.n(m),h=n(89793),u=n.n(h),$=n(23940),F=n.n($),B=n(67879),Q=n(53038),oe=n(60216),o=n.n(oe),ge=n(56755),fe=n(33827),ye=n(94547),_=n(19786),D=n(49372),Pe=n(73269),he=n(32237),K=n(198),M=n(8471),Z=n(92318),we=n(35331);const Be=(0,M.ZP)(T.k)`
  border-radius: 50%;
